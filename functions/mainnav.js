...
topnav.innerHTML += `         
<a class="active" href="#profile">Main</a>
...
function loadDrawings(allDrawings) {
  allDrawings.forEach(drawing => {
    ...
    user.innerText = `Created By ${drawing.user.username}`;
    let likeButton = document.createElement("img");
    likeButton.setAttribute("id", `${drawing.id}`);

    likeButton.src = "./assets/unlike.png";
    likeButton.style.cssText = "width:3%;";
